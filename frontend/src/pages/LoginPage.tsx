    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10 sm:px-6">
      ...
      <div className="flex w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl shadow-slate-900/10 ring-1 ring-slate-900/5">
        ...
        <aside
          ...
          className="hidden w-1/2 flex-col justify-center gap-10 bg-sigefi-blue-950 p-12 text-white lg:flex"
        >
          ...
          <div>
            ...
            <p className="mt-1.5 font-['Caveat',_cursive] text-3xl font-bold leading-tight text-sigefi-yellow">
        ...
        <main className="flex w-full flex-col justify-center px-6 py-10 sm:px-10 lg:w-1/2 lg:px-14">
          ...
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-sigefi-blue-950 text-sm font-bold text-white">
              SF
            </div>
            <div>
            ...
            <form onSubmit={handleSubmit} noValidate className="mt-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-lg border border-slate-300 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-900 outline-none transition focus:border-sigefi-blue-950 focus:bg-white focus:ring-2 focus:ring-sigefi-blue-100"
                />
              </div>
              ...
              {error && (
                <div
                  id={errorId}
                  role="alert"
                  className="rounded-lg bg-red-50 px-3.5 py-2.5 text-sm text-sigefi-red"
                >
                  {error}
                </div>
              )}
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-sigefi-blue-950 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-sigefi-blue-900 disabled:cursor-not-allowed disabled:opacity-60"
              >
